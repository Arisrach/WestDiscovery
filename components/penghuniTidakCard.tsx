...
export default function PenghuniTidakCard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const rawValue = rows[138]?.[2] ?? "Tidak ditemukan"; // D16 ada di index [15][3]
  ...
  return (
    <div className="flex items-center p-4 bg-white border-2 border-black rounded-md shadow-[8px_8px_0px_#000]">
      ...
      <div className="ml-4">
        <h2 className="text-md font-thin text-gray-500">Belum Terdata</h2>
